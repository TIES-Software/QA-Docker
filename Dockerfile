...
#RUN CHROMEDRIVER_VERSION=`curl -sS chromedriver.storage.googleapis.com/LATEST_RELEAS` \
RUN CHROMEDRIVER_VERSION=`curl -sS chromedriver.storage.googleapis.com/index.html?path=2.29/` \
