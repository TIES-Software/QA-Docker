...
ENV CHROME_URL="https://dl.google.com/linux/direct" \
    CHROME_BASE_DEB_PATH="/tmp/chrome-deb" \
...
RUN apt -qqy update \
  ...
  && apt -qyy --no-install-recommends install \
        "${CHROME_BASE_DEB_PATH}/google-chrome-stable_current_amd64.deb" \
  && rm "${CHROME_BASE_DEB_PATH}/google-chrome-stable_current_amd64.deb" \
